    ...
    <div class="mx-auto w-[92%] sm:w-[90%] md:w-[88%] lg:w-[85%] py-12 md:py-16 max-w-4xl">
        ...
        <div class="mt-10 space-y-8 text-sm text-[var(--color-muted)] leading-relaxed">
            <div>
                ...
                <p>These Terms & Conditions ("Terms") govern your use of the Structbrew Store website and all purchases made through it. By placing an order, you agree to be bound by these Terms. We reserve the right to update these Terms at any time — the latest version is always available on this page.</p>
            </div>
            ...
            <div>
                ...
                <p>All content on this website — including text, images, logos, and design — is owned by Structbrew Store or its licensors and is protected by copyright and trademark laws. You may not reproduce, distribute, or use any content without our prior written consent.</p>
            </div>

            <div>
                <h2 class="text-lg font-bold text-[var(--color-text)] mb-2">8. Limitation of Liability</h2>
                <p>To the maximum extent permitted by law, Structbrew Store shall not be liable for any indirect, incidental, or consequential damages arising from your use of the website or products purchased. Our total liability shall not exceed the amount you paid for the relevant order.</p>
            </div>
            ...
            <div>
                ...
                <p>Questions about these Terms? <a href="/contact" class="text-[var(--color-accent)] hover:underline">Contact us</a> or email legal@structbrew.store.</p>
            </div>
        </div>
    </div>
</section>
