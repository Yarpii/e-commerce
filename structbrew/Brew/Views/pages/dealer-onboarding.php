<section class="bg-[var(--color-bg)]">
    <div class="mx-auto w-[92%] sm:w-[90%] md:w-[88%] lg:w-[85%] py-12 md:py-16">
        ...
        <p class="mt-3 text-[var(--color-muted)] max-w-2xl">Become an authorized Structbrew dealer and grow your tech retail business with our curated product range.</p>
